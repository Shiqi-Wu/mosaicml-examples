...
dataset_name_mapper = {}
dataset_name_mapper['c4'] = 'allenai/c4'
...
class NoConcatDataset(IterableDataset):
    ...
    def __init__(self, dataset_name: str, data_subset: Union[str, None],
                 split: str):
        mapped_dataset_name = dataset_name_mapper[dataset_name]
        self.hf_dataset = hf_datasets.load_dataset(path=mapped_dataset_name,
                                                   name=data_subset,
                                                   split=split,
                                                   streaming=True)
